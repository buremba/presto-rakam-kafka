        ...
        implements Closeable
{
            ...
            throws IOException
    {
        ...
        KafkaConfig config = new KafkaConfig(TestUtils.toProperties(properties));
    ...
    public CloseableProducer<Long, Object> createProducer()
    {
        ...
        ProducerConfig producerConfig = new ProducerConfig(TestUtils.toProperties(properties));
