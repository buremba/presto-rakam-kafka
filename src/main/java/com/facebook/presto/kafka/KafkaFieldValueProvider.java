...
public abstract class KafkaFieldValueProvider
{
    ...
    public long getLong()
    {
        throw new PrestoException(KafkaErrorCode.KAFKA_CONVERSION_NOT_SUPPORTED, "conversion to long not supported");
    }
    ...
    {
        throw new PrestoException(KafkaErrorCode.KAFKA_CONVERSION_NOT_SUPPORTED, "conversion to Slice not supported");
    }
